        ...
        <div className="grid lg:grid-cols-6 gap-4">
          <div className="col-start-2 col-span-4 ...">
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="font-black text-3xl mt-3">
                      <span className="bg-indigo-500 text-white px-5">
                        <span className="text-sm">{t.price}</span> 50,000 ฿
                      </span>
                    </h3>
            ...
            <section className="mt-20">
              ...
              >
                <div>
                  <a href="https://res.cloudinary.com/techelegance/image/upload/v1623389310/Tech%20Elegance/portfolio/moblie/03_Welcome_jfgyhp.jpg">
                    <div
                      className={"shadow-md " + style.image_moblie}
                      style={{
                        backgroundImage: `url("https://res.cloudinary.com/techelegance/image/upload/v1623389310/Tech%20Elegance/portfolio/moblie/03_Welcome_jfgyhp.jpg")`,
                      }}
                    />
                  </a>
                </div>
                <div>
                  <a href="https://res.cloudinary.com/techelegance/image/upload/v1623389310/Tech%20Elegance/portfolio/moblie/07_MenusOpen_nglmh9.jpg">
                    <div
                      className={"shadow-md " + style.image_moblie}
                      style={{
                        backgroundImage: `url("https://res.cloudinary.com/techelegance/image/upload/v1623389310/Tech%20Elegance/portfolio/moblie/07_MenusOpen_nglmh9.jpg")`,
                      }}
                    />
                  </a>
                </div>
                <div>
                  <a href="https://res.cloudinary.com/techelegance/image/upload/v1623389310/Tech%20Elegance/portfolio/moblie/04_SignIn_nxxwbx.jpg">
                    <div
                      className={"shadow-md " + style.image_moblie}
                      style={{
                        backgroundImage: `url("https://res.cloudinary.com/techelegance/image/upload/v1623389310/Tech%20Elegance/portfolio/moblie/04_SignIn_nxxwbx.jpg")`,
                      }}
                    />
                  </a>
                </div>
              ...
              <div className="grid md:grid-cols-4 grid-cols-2 gap-4 ">
                ...
                <div className="flex items-center mt-10">
                  <Image
                    ...
                    width="50"
                  />
                  <span className="ml-3 font-semibold">React Native</span>
                </div>
                <div className="flex items-center mt-10">
                  <Image
                ...
                <div className="flex items-center mt-10">
                  <Image
                    src="https://res.cloudinary.com/techelegance/image/upload/v1623229378/Tech%20Elegance/landing%20page/language/graphql-icon_sf27vs.svg"
                    height="50"
                    width="50"
                  />
                  <span className="ml-3 font-semibold">GraphQL</span>
                </div>
              </div>
            </section>
          </div>
